...
export const DEFAULT_ROLE_MATRIX: Record<string, UserRole[]> = {
  ...
  MENU_CHAT: ['ADMIN', 'CHEF', 'SECRETAIRE', 'PROTOCOL', 'CEMG', 'SALLE_ATTENTE', 'OBSERVATEUR', 'ASSISTANT'],
  MENU_SETTINGS: ['ADMIN', 'CHEF', 'SECRETAIRE', 'PROTOCOL', 'CEMG', 'SALLE_ATTENTE', 'OBSERVATEUR', 'ASSISTANT'],
  MENU_AUDIT: ['ADMIN'],
